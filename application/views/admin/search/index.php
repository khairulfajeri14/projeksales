      <?php
      if (count($beritalist)==0 && count($kendaraanlist)==0){
        redirect(site_url().'Search/nofile');
      ...
      ?>
          ...
          <h1 class="page-header">Search <?php echo $isi?></h1>
<?php 
          if(count($beritalist)==0) echo "<!--"
        ?>
